...
# sphinx-quickstart on Fri Aug  3 23:11:59 2012.
#
...
project = u'Larch'
copyright = u'2010-2019, Jeffrey Newman'
...
# one output are not. As always, per-notebook settings take precedence over the
# settings in conf.py.
...
intersphinx_mapping = {
	...
	'apsw': ('http://rogerbinns.github.io/apsw/', None), # 'apsw_3_8_7_3.inv'
...
# of the sidebar.
#html_logo = '../img/blocklogo_white.png'

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = '../../img/larch_favicon.ico'
...
# Additional stuff for the LaTeX preamble.
    'preamble': "".join((
        ...
        r'\DeclareUnicodeCharacter{2640}{\\female}',

        r'\DeclareUnicodeCharacter{2500}{-}',  # BOX DRAWINGS
        r'\DeclareUnicodeCharacter{2502}{|}',  # BOX DRAWINGS
        r'\DeclareUnicodeCharacter{2504}{-}',  # BOX DRAWINGS
        r'\DeclareUnicodeCharacter{251C}{+}',  # BOX DRAWINGS
        r'\DeclareUnicodeCharacter{252C}{+}',  # BOX DRAWINGS
        r'\DeclareUnicodeCharacter{253C}{+}',  # BOX DRAWINGS
        r'\DeclareUnicodeCharacter{2550}{=}',  # BOX DRAWINGS
        r'\DeclareUnicodeCharacter{2567}{=}',  # BOX DRAWINGS
...
man_pages = [
    ('index', 'Larch', u'Larch Documentation',
     [u'Jeffrey Newman'], 1)
]
...
texinfo_documents = [
  ('index', 'larch', u'larch Documentation',
   u'Jeffrey Newman', 'larch', 'One line description of project.',
   'Miscellaneous'),
]
