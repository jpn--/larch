...
class Model2(sherpa):
    ...
    def mnl_gradient_full_casewise(self) -> "std::shared_ptr< etk::ndarray >" : return _core.Model2_mnl_gradient_full_casewise(self)
    ...
    def Quantity(self) -> "etk::ndarray *" : return _core.Model2_Quantity(self)
