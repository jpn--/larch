...
class TestSwissmetroExamples(ELM_TestCase):
	...
	def test_swissmetro01logit(self):		
		...
		M = model()
		M.estimate()
		self.assertNearlyEqual(   -5331.2520069781867 , M.LL())
		...
		self.assertNearlyEqual(2.8640528329606779e-07 , M.parameter("ASC_CAR").robust_covariance['B_COST'    ])
	...
	def test_swissmetro11crossnested(self):
		...
		self.assertAlmostEqual(      -5214.0491950955357, M.LL()                                     ,6)
