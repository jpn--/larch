...
if os.environ.get('READTHEDOCS', None) == 'True':
	...
	# To update the version, run `git tag -a 3.3.13 -m'version 3.3.13, September 2016'`
...
#		swig_files = [file_at('src/swig/elmcore_wrap.cpp')]
	...
	setup(name='larch',
		  ...
		  package_data={'larch':['data_warehouse/*.sqlite', 'data_warehouse/*.csv', 'data_warehouse/*.csv.gz', 'data_warehouse/*.h5', 'data_warehouse/*.h5.gz', 'util/*.mplstyle'], 'larch.examples.doc':['*.rst']},
