...
if os.environ.get('READTHEDOCS', None) == 'True':
	...
	setup(name='larch',
		  ...
		  packages=['larch', 'larch.examples', 'larch.version', 'larch.util', 'larch.util.optimize', 'larch.model_reporter', 'larch.dt'],
	...
	# To update the version, run `git tag -a 3.3.22 -m'version 3.3.22, September 2016'`
...
#		swig_files = [file_at('src/swig/elmcore_wrap.cpp')]
	...
	setup(name='larch',
		  ...
		  packages=['larch', 'larch.examples','larch.examples.doc', 'larch.test', 'larch.version',
		            'larch.util', 'larch.model_reporter', 'larch.util.optimize', 'larch.dt', ],
		  ext_modules=[core, apsw, ],
		  package_data={'larch':['data_warehouse/*.sqlite', 'data_warehouse/*.csv',
		                         'data_warehouse/*.csv.gz', 'data_warehouse/*.h5',
								 'data_warehouse/*.h5.gz', 'util/*.mplstyle'],
						'larch.examples.doc':['*.rst']},
