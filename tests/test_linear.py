...
def test_piecewise_linear():
	...
	assert func[0] == P('ParamName[1]: up to 3') * X('piece(DataName,None,3)')
	assert func[1] == P('ParamName[2]: 3 to 5') * X('piece(DataName,3,5)')
	assert func[2] == P('ParamName[3]: 5 to 7') * X('piece(DataName,5,7)')
	assert func[3] == P('ParamName[4]: over 7') * X('piece(DataName,7,None)')
	assert len(func) == 4

	func = piecewise_linear(X.DataName, breaks=[3, 5, 7])
	assert func[0] == P('DataName[1]: up to 3') * X('piece(DataName,None,3)')
	assert func[1] == P('DataName[2]: 3 to 5') * X('piece(DataName,3,5)')
	assert func[2] == P('DataName[3]: 5 to 7') * X('piece(DataName,5,7)')
	assert func[3] == P('DataName[4]: over 7') * X('piece(DataName,7,None)')
	assert len(func) == 4

	func = piecewise_linear('GenName', breaks=[3, 5, 7])
	assert func[0] == P('GenName[1]: up to 3') * X('piece(GenName,None,3)')
	assert func[1] == P('GenName[2]: 3 to 5') * X('piece(GenName,3,5)')
	assert func[2] == P('GenName[3]: 5 to 7') * X('piece(GenName,5,7)')
	assert func[3] == P('GenName[4]: over 7') * X('piece(GenName,7,None)')
	assert len(func) == 4
