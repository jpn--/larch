...
def test_dataframes_nl_holdfasts():
	...
	ll3 = m5.loglike2_bhhh(return_series=True, persist=PERSIST_ALL)
...
def test_logsums():
	...
	m1.utility_co[2] = m2.utility_co[2] = (
	...
	m1.utility_co[3] = m2.utility_co[3] = (
			+ P.vehbywrk_SR * X.vehbywrk
	...
	m1.utility_co[4] = m2.utility_co[4] = (
			+ P('hhinc#4') * X.hhinc
	...
	m1.utility_co[5] = m2.utility_co[5] = (
			+ P('hhinc#5') * X.hhinc
	...
	m1.utility_co[6] = m2.utility_co[6] = (
			+ P('hhinc#6') * X.hhinc
	...
	m1.availability_var = m2.availability_var = '_avail_'

	m1.choice_ca_var = m2.choice_ca_var = '_choice_'
	...
	assert m1.exputility()[:5] == approx(numpy.array([
		[0.7703317, 0.03670625, 0.0114858, 0.04007882, 0.00195545, 0.],
		[0.25262916, 0.26815995, 0.31474365, 1.54292272, 0.03073125, 0.],
		[0.65077558, 0.16045596, 0.09063308, 0.33690284, 0., 0.],
		[0.45753251, 0.1902941, 0.160944, 0.97154771, 0., 0.],
		[0., 0.18792903, 0.10328456, 0.44164561, 0.03483948, 0.],
	]))
